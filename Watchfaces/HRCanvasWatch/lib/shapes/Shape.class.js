class Shape {
	  ...
	  isInSurface(clickPos,offset){
		  //console.log('shape coords x: '+this.x+" x-fixed: "+(this.x-offset)+" y: "+this.y+" y-fixed: "+(this.y-offset));
		  //console.log('shape coords x: '+(this.x+this.width)+" x-fixed: "+(this.x+this.width+offset)+" y: "+(this.y+this.height)+" y-fixed: "+(this.y+this.height+offset));
		  return ((clickPos.x >= (this.x-offset) && clickPos.x <= (this.x+this.width+offset))    && (clickPos.y  >= (this.y-offset)  && clickPos.y <= (this.y+this.height+offset) ));
	  }
